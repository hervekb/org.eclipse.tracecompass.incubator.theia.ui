...
import org.eclipse.tracecompass.incubator.theia.ui.core.data.provider.TickLatencyDataProvider;
...
public class TickLatencyXYChart extends TmfChartView{
	
	 /** View ID. */
   public static final String ID = "org.eclipse.tracecompass.incubator.theia.ui.views.tick.dataprovider.xyview"; //$NON-NLS-1$

   /**
    * Constructor
    */
   public TickLatencyXYChart() {
   ...
   protected TmfXYChartViewer createChartViewer(@Nullable Composite parent) {
       ...
       return new TmfFilteredXYChartViewer(parent, settings, TickLatencyDataProvider.ID);
   }

   private static final class TreeXyViewer extends AbstractSelectTreeViewer2 {

       public TreeXyViewer(Composite parent) {
           super(parent, 1, TickLatencyDataProvider.ID);
       }
