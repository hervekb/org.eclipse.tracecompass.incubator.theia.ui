...
import org.eclipse.tracecompass.incubator.theia.ui.core.data.provider.ThreadPoolDataProvider;
...
public class ThreadPoolView extends TmfChartView{
	
	 /** View ID. */
   public static final String ID = "org.eclipse.tracecompass.incubator.theia.ui.views.pool.dataprovider.xyview"; //$NON-NLS-1$
   ...
   protected TmfXYChartViewer createChartViewer(@Nullable Composite parent) {
       ...
       return new TmfFilteredXYChartViewer(parent, settings, ThreadPoolDataProvider.ID);
   }

   private static final class TreeXyViewer extends AbstractSelectTreeViewer2 {

       public TreeXyViewer(Composite parent) {
           super(parent, 1, ThreadPoolDataProvider.ID);
       }
