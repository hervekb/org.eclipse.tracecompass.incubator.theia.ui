...
import org.eclipse.tracecompass.incubator.theia.ui.core.data.provider.TimerDataProvider;
...
public class TimerXYChart extends TmfChartView{
	
	 /** View ID. */
   public static final String ID = "org.eclipse.tracecompass.incubator.theia.ui.views.timer.dataprovider.xyview"; //$NON-NLS-1$
