...
public class TickLatencyDataProvider extends AbstractTreeDataProvider<TheiaStateSystemAnalysisModule, TmfTreeDataModel> implements ITmfTreeXYDataProvider<TmfTreeDataModel> {
	
	
	    public static final String ID = "org.eclipse.tracecompass.incubator.theia.ui.xy.tick.dataprovider"; //$NON-NLS-1$
	     ...
	     *            The analysis module
	     */
	    public TickLatencyDataProvider(ITmfTrace trace, TheiaStateSystemAnalysisModule analysisModule) {
	    ...
	    public static @Nullable ITmfTreeDataProvider<? extends ITmfTreeDataModel> create(ITmfTrace trace) {
	        ...
	        return module != null ? new TickLatencyDataProvider(trace, module) : null;
	    }
	    ...
	    protected TmfTreeModel<TmfTreeDataModel> getTree(ITmfStateSystem ss, Map<String, Object> fetchParameters, @Nullable IProgressMonitor monitor) throws StateSystemDisposedException {
	        ...
	        for (Integer quark : ss.getQuarks("THEIA","Metrics","Tick_latency","*")) { //$NON-NLS-1$ //$NON-NLS-2$
