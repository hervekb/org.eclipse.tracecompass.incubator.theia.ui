...
public class ThreadPoolDataProvider extends AbstractTreeDataProvider<TheiaStateSystemAnalysisModule, TmfTreeDataModel> implements ITmfTreeXYDataProvider<TmfTreeDataModel> {
	
	
	    public static final String ID = "org.eclipse.tracecompass.incubator.theia.ui.xy.pool.dataprovider"; //$NON-NLS-1$
	     ...
	     *            The analysis module
	     */
	    public ThreadPoolDataProvider(ITmfTrace trace, TheiaStateSystemAnalysisModule analysisModule) {
	    ...
	    public static @Nullable ITmfTreeDataProvider<? extends ITmfTreeDataModel> create(ITmfTrace trace) {
	        ...
	        return module != null ? new ThreadPoolDataProvider(trace, module) : null;
	    }
	    ...
	    protected TmfTreeModel<TmfTreeDataModel> getTree(ITmfStateSystem ss, Map<String, Object> fetchParameters, @Nullable IProgressMonitor monitor) throws StateSystemDisposedException {
	        ...
	        for (Integer quark : ss.getQuarks("THEIA","Metrics","Workers_latency","*")) { //$NON-NLS-1$ //$NON-NLS-2$
