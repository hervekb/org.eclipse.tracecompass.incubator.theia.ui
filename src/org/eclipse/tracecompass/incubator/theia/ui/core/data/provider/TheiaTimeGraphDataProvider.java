...
@NonNullByDefault
public class TheiaTimeGraphDataProvider extends AbstractTmfTraceDataProvider implements ITimeGraphDataProvider<@NonNull ITimeGraphEntryModel>, IOutputStyleProvider {
     ...
     */
    public TheiaTimeGraphDataProvider(ITmfTrace trace, TheiaStateSystemAnalysisModule module) {
        super(trace);
        fModule = module;
    }
